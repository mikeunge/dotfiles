...
g.nvim_tree_side = 'left'	-- nvim_tree opens left
g.nvim_tree_width = 40		-- define the width
g.nvim_tree_ignore = { '.git', 'node_modules', '.cache' }	-- ignore list
g.nvim_tree_gitignore = 1	-- parse gitignore
g.nvim_tree_auto_open = 0	-- don't auto-open
